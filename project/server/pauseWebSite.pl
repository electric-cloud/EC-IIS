# -------------------------------------------------------------------------
   ...
   use constant {
       ...
       IIS_VERSION_6 => 'iis6',
       IIS_VERSION_7 => 'iis7',
       DEFAULT_PAUSE_COMMAND_OPTION_IIS_6 => '/pause',
       DEFAULT_PAUSE_COMMAND_OPTION_IIS_7 => 'delete site',
...
#            exit ERROR;
    ...
    if($iisVersion eq IIS_VERSION_6){
        ...
        #using vbs scripts
        push(@args, DEFAULT_PAUSE_COMMAND_OPTION_IIS_6);
        ...
        #using AppCmd
        push(@args, DEFAULT_PAUSE_COMMAND_OPTION_IIS_7);
    ...
    if($cmdLine && $cmdLine ne ''){
        ...
        if($? == SUCCESS){
            ...
            if($content !~ m/has been PAUSED|is already PAUSED/){
