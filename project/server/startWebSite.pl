# -------------------------------------------------------------------------
   ...
   use constant {
       ...
       IIS_VERSION_6 => 'iis6',
       IIS_VERSION_7 => 'iis7',
       DEFAULT_START_COMMAND_OPTION_IIS_6 => '/start',
...
#            exit ERROR;
    ...
    if($iisVersion eq IIS_VERSION_6){
        ...
        #using vbs scripts
        push(@args, DEFAULT_START_COMMAND_OPTION_IIS_6);
        ...
        #using AppCmd
        push(@args, DEFAULT_START_COMMAND_OPTION_IIS_7);
