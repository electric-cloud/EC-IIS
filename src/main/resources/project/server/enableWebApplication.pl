...
# line 4 "[EC]/@PLUGIN_KEY@-@PLUGIN_VERSION@/enableWebApplication.pl"
# -------------------------------------------------------------------------
# File
...
try {
    ...
    if("$enableRecursive" == "1"){
        WScript.Echo("Enabling application recursively...");
        xvdir.AppEnableRecursive();
    }else{
...
print "Enable Application Results:\n";
print @webappresult;
