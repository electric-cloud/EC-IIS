...
# line 4 "[EC]/@PLUGIN_KEY@-@PLUGIN_VERSION@/createVirtualDirectory.pl"
#
...
$::gPhysicalPath =
  ( $::gEC->getProperty("physicalpath") )->findvalue("//value");
...
sub main() {
    ...
    $cmdLine =
"$appcmdLocation add vdir /app.name:\"$::gAppName\" /path:\"$::gPath\" /physicalPath:\"$::gPhysicalPath\"";
